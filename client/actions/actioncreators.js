...
export function getData(city) {
	...
	return dispatch => {
		...
		fetchJsonp('http://api.wunderground.com/api/b177596eb43ca2fe/forecast10day/q/zmw:'+city+'.json')
...
export function getConditions(city) {
	...
	return dispatch => {
		...
		fetchJsonp('http://api.wunderground.com/api/b177596eb43ca2fe/conditions/q/zmw:'+city+'.json')
		.then(response=>{return response.json()})
